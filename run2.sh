...
# sbatch run.sh --model cc --cc_neurosym --abstract_pen 1 --traj_updates 2E7
# sbatch run.sh --model cc --cc_neurosym --abstract_pen 1 --traj_updates 2E7
# sbatch run.sh --model cc --abstract_pen 1 --traj_updates 2E7 --b 21
...
# sbatch run.sh --model hmm --abstract_pen 1 --traj_updates 4E7 --length '(1, )'
# sbatch run.sh --model hmm --abstract_pen 1 --traj_updates 4E7 --length '(1, )'
# sbatch run.sh --model hmm --abstract_pen 1 --traj_updates 4E7 --length '(2, )'
# sbatch run.sh --model hmm --abstract_pen 1 --traj_updates 4E7 --length '(2, )'
# sbatch run.sh --model hmm --abstract_pen 1 --traj_updates 4E7 --length '(3, )'
# sbatch run.sh --model hmm --abstract_pen 1 --traj_updates 4E7 --length '(3, )'
# sbatch run.sh --model hmm --abstract_pen 1 --traj_updates 4E7 --length '(4, )'
# sbatch run.sh --model hmm --abstract_pen 1 --traj_updates 4E7 --length '(4, )'
