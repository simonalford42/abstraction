...
class HeteroController(nn.Module):
    ...
    def neurosym_macro_transitions(self, t_i, bs):
        ...
        t_i2 = repeat(t_i, 'T (p C1 C2 2) -> (T repeat) p C1 C2 2', repeat=nb, p=2, C=box_world.NUM_COLORS)
        ...
        out = rearrange(out, '(T |bs|) p C1 C2 2 -> T |bs| (p C1 C2 2))', p=2, C=box_world.NUM_COLORS)
        return out
